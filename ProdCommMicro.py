...
class MicDisp(Display):
    def __init__(self, parent=None, args=None, ui_filename="FFT_test.ui"):
        ...
        self.ui.StrtBut.clicked.connect(
            partial(self.setGOVal, XfelPlot)
    ...
    def setGOVal(self, ac):
        ...
        (
            ...
            self.getUserVal()
        )  # This gets the User inputs from the spinBox and checkboxes
        ...
        if lastPath[48:50] == cmNumSt and lastPath[50:51] == cavity[0:1]:
            ...
            if (
                ...
                if cavNumA != "":
                    botPath = (
                        botPath + cavNumA[0] + "0/" + botPath + cavNumA[0] + "0_" + s1
                    )
                    caCmd = "ca://ACCL:" + liNac + ":" + str(cmNumSt) + "00:RESA:"

                if cavNumB != "":
                    botPath = (
                        botPath + cavNumB[0] + "0/" + botPath + cavNumB[0] + "0_" + s1
                    )
                ...
                try:
                    ...
                    if return_code != 0:
                        e = subprocess.CalledProcessError(
                            return_code, cmdList, output=out
                        )
    ...
    def getDataBack(self, ac):
        ...
        if dirs != []:
            ...
            if indexPlot == 1:
                ...
                ac.axes.cla()
                ac.axes.hist(
                    cavDat1, bins=140, histtype="step", log="True", edgecolor="b"
                )
                if "1" in cavNumA:
                    leGend.append("Cav1")
                if "2" in cavNumA:
